...
parser.add_argument(
    "--learning_rate", type=float, default=0.005, help="The learning rate to use"
)
parser.add_argument(
...
parser.add_argument(
    "--out_dim", default=128, type=int, help="feature dimension (default: 64)"
)
parser.add_argument(
